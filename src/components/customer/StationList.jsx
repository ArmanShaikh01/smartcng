    ...
    return (
        ...
        >
            ...
            {!rushLoading && bestHour !== null && (
                <div style={{ fontSize: '0.75rem', color: '#6b7280', padding: '4px 4px 0', display: 'flex', alignItems: 'center', gap: 5 }}>
                    <span>💡</span>
                    <span>Best time to visit: <strong>{formatHour(bestHour)}</strong></span>
                </div>
            )}

...
const Profile = () => {
    ...
    const handleAddVehicle = async () => {
        ...
        const result = validateVehicleNumber(newVehicle);
        if (!result.valid) {
    ...
    const handleRemoveVehicle = async (vehicle) => {
        const ok = await confirm(`Remove vehicle ${vehicle} from your account?`, {
                        ...
                        <div className="profile-section">
                            ...
                            <div className="add-vehicle-row">
                                <input
                                    ...
                                    value={newVehicle}
                                    onChange={e => setNewVehicle(e.target.value.toUpperCase().replace(/[^A-Z0-9]/g, '').slice(0, 10))}
                                    maxLength={10}
